...
public:
    ...
    /**
     * @brief Trả về SSID của mạng đang được chọn.
     * @return String: SSID của mạng được chọn, hoặc chuỗi rỗng nếu không có mạng nào được chọn.
     */
    String getSelectedSSID(); // <-- Hàm getter đã thêm
